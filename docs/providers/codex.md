...
- **Spend tiles show "No data"** — MaxUsage found no Codex session logs in the last 30 days. If your Codex home lives somewhere custom, set `CODEX_HOME` so both the Codex CLI and MaxUsage look in the same place.
