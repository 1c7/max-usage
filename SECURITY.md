...
If you find a security vulnerability in MaxUsage, please report it responsibly. Do not open a public issue if possible.

### GitHub Security Advisories

1. Go to the [Security Advisories page](https://github.com/1c7/max-usage/security/advisories/new)
...
- The MaxUsage desktop application
